...
const GsapTimeline = () => {
  ...
  useGSAP(() =>{timeline.to('#yellow-box', {x: 250,
    rotaion:360,
    borderRadius: 360,
    duration: 2,
    ease: 'back.inOut'
  })
  timeline.to('#yellow-box',{y:200,scale:2,rotation:120,
    borderRadius:'8px', duration:5, ease:'bounce.inOut',
  })
timeline.to('#yellow-box',{x: 500,
  scale: 1,
  rotaion:360,
  borderRadius: '8px',
  duration: 2,
  ...
  return (
    <main>
      ...
      <div className="mt-20 space-y-10">
        <button onClick={() => {if(timeline.paused()){timeline.play();}else{timeline.pause();}}}>Play/Pause</button>
